...
from demoloader.vgg_bn import vgg19_bn
...
def generate_cls_model(
    ...
    if model_name == 'resnet18':
        ...
        if kwargs.get("pretrained", False):
            ...
            # changed 
            net = PreActResNet18(input_channel=input_channel, num_classes=num_classes)
    # changed 
    elif model_name == 'cnn':
        net = CNN(input_channel=input_channel, num_classes=num_classes)
    ...
    # changed 
        ...
        net = vgg19_bn(input_channel=input_channel, num_classes=num_classes)
